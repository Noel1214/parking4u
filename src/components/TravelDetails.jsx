      ...
      <form className="flex flex-col gap-3 mt-11 items-center">
        ...
        <div className="flex gap-2 w-[25rem] justify-between">
          <div>
            ...
            <input type="date" className="h-10 w-[12rem] p-2 outline-none rounded-md" />
          </div>
          <div>
        ...
        {/* Submit Details  */}
        <div className="">
          <button className="h-10 w-[25rem] rounded-md text-white font-semibold text-sm bg-zinc-400 mt-6 bg-opacity-35 hover:bg-opacity-65 transition-all ease-in-out duration-200"> Find Parking</button>
        </div>
      </form>
    </div>
  );
