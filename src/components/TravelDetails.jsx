...
const TravelDetails = () => {
  return (
    <div className="h-[32rem] w-[27rem] border-[0.5px] border-zinc-500 bg-black bg-opacity-55 rounded-3xl scale-75 lg:scale-[0.85] lg:hover:scale-90 overflow-hidden transition-all duration-300 ease-in-out">
