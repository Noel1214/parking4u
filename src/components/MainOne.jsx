...
const MainOne = () => {
  return (
    <div className="flex justify-center">
      <div className="h-[45rem] lg:h-[35rem] w-[90vw] flex flex-col lg:flex-row justify-center lg:justify-evenly items-center bg-black bg-opacity-55 rounded-3xl pt-24 pb-10 lg:pb-9">
